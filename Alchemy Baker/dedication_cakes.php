...
$sql = "SELECT dedication_id, name, price, image_url FROM dedicationcakes";
...
<html>
<head>
    <title>Alchemy Bakery - Dedication Cakes</title>
</head>
    ...
    <header class="text-center py-5 bg-danger text-white">
        ...
        <h1 class="fg-bold text-white">Dedication Cakes</h1>
    </header>
