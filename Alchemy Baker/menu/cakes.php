...
$sql = "SELECT cake_id, name, price, image_url FROM Cakes";
...
<html>
<head>
    <title>Cakes | Alchemy Bakery</title>
...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <header class="text-center py-5 bg-danger text-white">
        ...
        <h1 class="fg-bold text-white">Cakes</h1>
    </header>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="cake">
                    ...
                    <!-- <form action="delete.php" method="POST">
                        <input type="hidden" name="cake_id" value="<?php echo $row['cake_id']; ?>">
